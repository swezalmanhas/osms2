...
<div class="main-container">
        ...
        <div class="aside">
            ...
            <ul class="nav">
                ...
                <li><a href="#Login" style="color:var(--skin-color);"><i class="fa fa-comments"></i> Admin Login </a></li>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <form action="" method="POST" class="shadow-lg p-4">
                                    <div class="form-group">
                                        <i class="fas fa-user" style="color: var(--text-black-900);"></i><label for="aemail" class="font-weight-bold pl-2" style="color: var(--text-black-900);">Email</label>
                                    ...
                                    <div class="form-group">
                                        <i class="fas fa-key" style="color: var(--text-black-900);"></i><label for="pass" class=" mt-3 font-weight-bold pl-5" style="color: var(--text-black-900);">Password</label>
