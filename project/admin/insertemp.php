...
<body>
  ...
  <h3 class="text-center" style="color: orangered;">Add New Technician</h3>
  <form action="" method="POST" style="color: white;" class="mr-5">
    ...
    <div class="form-group mt-3">
      ...
      <input type="text" class="form-control" id="empMobile" name="empMobile" onkeypress="isInputNumber(event)" pattern=".{10}">
    </div>
    ...
    <div class="text-center mt-5">
      <button type="submit" class="btn " id="empsubmit" name="empsubmit">Submit</button>
      <a href="technician.php" class="btn pd-2">Close</a>
    </div>
